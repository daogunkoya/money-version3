					...
					<div class="col-md-4">
					   ...
					   <table id="sort-table" class="table table-striped tablesorter">
						...
						<tr>
							...
							<td><a href="{{route('beneficiaries.edit',$receiver->id)}}">
								<?php  echo ucfirst($receiver->title)." ".ucfirst($receiver->fname)." ". ucfirst($receiver->lname);?></a></a></td>
							
							<td><?php  echo $receiver->phone;?></td>
								
						 	
						 	<td><a href="{{route('beneficiaries.edit',$receiver->id)}}" class="btn btn-primary"><i class="fa fa-users fa-lg"> Modify</a></td>	

						 	{!! Form::open(['method'=>'DELETE', 'action'=>[ 'CustomerReceiversController@destroy', $receiver->id ], 'files'=>true]) !!}	
