					   ...
					   <table id="sort-table" class="table table-striped tablesorter">
						...
						<tr>
							...
							<td><?php  echo $receiver->phone;?></td>
						 	...
						 	<td><a href="{{route('receivers.edit',$receiver->id)}}" class="btn btn-primary"><i class="fa fa-users fa-lg"> Modify</a></td>	

						 	{!! Form::open(['method'=>'DELETE', 'action'=>[ 'AgentCustomerReceiversController@destroy', $receiver->id ], 'files'=>true]) !!}	
