...
<!-- Form -->
		{!! Form::model($agentcustomer,['method'=>'PATCH', 'action'=> ['AgentCustomerController@update',$agentcustomer->id], 'files'=>true]) !!}
					...
					<div class="panel-body">
								...
								<div class="col-md-5 col-md-offset-1">
										...
										<div class="col-md-5">
												...
												<div class="form-group input-group form-group-sm">
													...
													{!! Form::text('dob', null, ['class'=>'form-control','id'=>'date1'])!!}
												</div>
										</div>
							</div>
							<div class="row">
							...
							<div class ="row">
								<div class="col-md-4 col-md-offset-2">
									<div class="form-group">
							            ...
							            <br/>
							            <img height="50" src="{{$agentcustomer->photo ? asset('images').'/'.$agentcustomer->photo->identity_proof : 'http://placehold.it/400x400' }} " alt="">
							        </div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
							            ...
							            <br/>
							            <img height="50" src="{{$agentcustomer->photo ? asset('images').'/'.$agentcustomer->photo->address_proof : 'http://placehold.it/400x400' }} " alt="">
							        </div>
								</div>
							</div>
						...
						{!! Form::close() !!}	
												<div class="col-md-6">
													{!! Form::open(['method'=>'DELETE', 'action'=> ['AgentCustomerController@destroy',$agentcustomer->id]]) !!}
